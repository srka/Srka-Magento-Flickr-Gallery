...
class Srka_Flickrgallery_Block_Photoset extends Srka_Flickrgallery_Block_View {
    ...
    public function getPhotoset(){
        return ( (array_key_exists('photoset', $this->_raw_photoset)) ? $this->_raw_photoset['photoset'] : array() );
    }

    public function getPhotos(){
        return ( (array_key_exists('photos', $this->_raw_photoset)) ? $this->_raw_photoset['photos'] : array() );
    }

    public function getPhotosetTitle(){
        return $this->_raw_photoset['photoset']['title'];
    }

    public function getPhotosetDescription(){
        return $this->_raw_photoset['photoset']['description'];
    }
